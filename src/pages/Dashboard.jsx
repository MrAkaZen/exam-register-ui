...
import AlunnoCard from '../components/alunno/AlunnoCard';
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid gap-8 xl:grid-cols-[280px_1fr]">
        ...
        <main className="space-y-8">
          ...
          <section className="grid gap-4 xl:grid-cols-3">
            <StatsCard icon={Users} label="Totale alunni" value={loading ? '...' : total} hint="Studenti registrati" accent="bg-indigo-500/15 text-indigo-300" />
            <StatsCard icon={Activity} label="Nuovi inserimenti" value={loading ? '...' : recent.length} hint="Ultimi 5 profili" accent="bg-emerald-500/15 text-emerald-300" />
            <StatsCard icon={BarChart3} label="Materie attive" value="—" hint="Da collegare al backend" accent="bg-violet-500/15 text-violet-300" />
          </section>
